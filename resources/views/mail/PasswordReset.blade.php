...
<head>
    ...
    <title>VOA+ | Password Reset Code</title>
</head>
<body>
<?php
$password_reset_code =session()->get('password_reset_code');
?>
<div class="container" style="background-color:#ECF0F1;text-align: center; border: 1px solid darkgray;">
    ...
    <div style="padding-left: 10px;padding-right: 10px; padding-bottom: 10px;">
        ...
        <p >
                        Thank you choosing to VOA+. Please use the following reset code to reset your password. (If are you did not request to password reset, please ignore this email.)
        </p>
        <div style="background-color:#0a4275; width: 100px; text-align: center; border-radius: 15px; margin: 0 auto;width: max-content;padding: 10px 50px; color: #fff;"> {{ $password_reset_code }}
